...
![部屋で椅子に座り、照明・エアコン・冷蔵庫・スマートフォン・パソコンを見回している人](images/elec_room/00_lead.svg)
...
![壁の三つのコンセントから分電盤の小さなスイッチへ線がつながる図](images/elec_room/01_room.svg)
...
![発電所から鉄塔・変電所・電柱の変圧器を経て家へ、電圧が数十万ボルトから100ボルトへ下がる図](images/elec_room/02_path.svg)
...
![資格が要らない作業(電球の交換、プラグの抜き差し)と資格が要る作業(壁の中の配線、コンセントの増設)を一本の線で分けた図](images/elec_room/03_line.svg)
...
![中央の電球を囲む、同じ人物の四つの横顔](images/elec_room/04_faces.svg)
...
![消費者・小売・送配電・発電の間のお金の流れと電気の流れ](images/elec_room/05_money.svg)
...
- 2026-09-14 実機確認の反映: 「根拠」を「この話のもと」に改め、表をリンク付きの一覧にした。URL文字列は表示しない。日付が取れない出典は「日付の記載なし、閲覧日」と書く。挿絵を冒頭一枚と各節一点(計六点、SVGの線画・図解)にした
